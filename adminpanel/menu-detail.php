...
$query = mysqli_query($con, "SELECT  a.*, b.nama AS nama_kategori FROM menu a JOIN kategori b ON a.kategori_id=b.id WHERE a.id='$id'");
    ...
    <div class="container mt-5">
        ...
        <div class="col-12 col-md-6">
            ...
            <?php
                    ...
                    $queryUpdate = mysqli_query($con, "UPDATE menu SET kategori_id='$kategori', nama='$nama', harga='$harga', detail='$detail', ketersediaan_stok='$ketersediaan_stok' WHERE id=$id");
            ...
            <?php
                                ...
                                $queryUpdate = mysqli_query($con, "UPDATE menu SET foto='$new_name' WHERE id='$id'");

                                if ($queryUpdate) {
             ?>
                                    <div class="alert alert-warning  mt-3" role="alert">
                                        Menu Berhasil Update
                                    </div>
            ...
            if(isset($_POST['hapus'])){
                $queryHapus = mysqli_query($con, "DELETE FROM menu WHERE id='$id'");
